...
(id, name, master_group_id, economic_group_id, area, operation_type, maturity_date, responsible_analyst, review_frequency, call_frequency, df_frequency, segmento, rating_operation, rating_group, watchlist, ltv, dscr, monitoring_news, monitoring_spe_dfs, status, description, moved_to_legacy_date, is_structuring, pipeline_stage, risk, temperature, liquidation_date, is_active, originator, modality, created_at) VALUES
-- ESTOQUE (is_structuring = FALSE ou NULL)
(10, 'CRI Edifício Faria Lima', 1, 1, 'CRI', 'CRI', '2032-06-30T00:00:00', 'Fernanda', 'Anual', 'Trimestral', 'Semestral', 'Asset Finance - FII', 'A4', 'A4', 'Verde', 0.50, 2.5, true, true, 'Ativa', 'Operação estabilizada de locação comercial. Alocada em FIIs.', NULL, FALSE, NULL, NULL, NULL, NULL, TRUE, NULL, NULL, '2024-01-01T00:00:00'),
(20, 'Debênture Agro Forte', 2, 3, 'Capital Solutions', 'Debênture', '2029-09-30T00:00:00', 'Ricardo', 'Semestral', 'Mensal', 'Semestral', 'Crédito Corporativo', 'Ba1', 'Baa4', 'Amarelo', 0.6, 1.5, true, false, 'Ativa', 'Dívida para ampliação de capacidade produtiva.', NULL, FALSE, NULL, NULL, NULL, NULL, TRUE, NULL, NULL, '2024-01-01T00:00:00'),
(30, 'CRI Shopping Pátio Central', 1, 2, 'CRI', 'CRI', '2027-03-31T00:00:00', 'Fernanda', 'Trimestral', 'Mensal', 'Trimestral', 'Asset Finance', 'B3', 'Ba5', 'Amarelo', 0.75, 1.2, true, true, 'Ativa', 'Recuperação judicial, foco em trazer novas âncoras.', NULL, FALSE, NULL, NULL, NULL, NULL, TRUE, NULL, NULL, '2024-01-01T00:00:00'),
(40, 'CRA Fazendas Reunidas', 2, 3, 'CRA', 'CRA', '2031-08-31T00:00:00', 'Ricardo', 'Semestral', 'Trimestral', 'Semestral', 'Crédito Corporativo', 'Ba4', 'Ba1', 'Verde', null, null, true, true, 'Ativa', 'Produção e exportação de soja e milho.', NULL, FALSE, NULL, NULL, NULL, NULL, TRUE, NULL, NULL, '2024-01-01T00:00:00'),
(50, 'CRI Logística Sul', 3, 4, 'CRI', 'CRI', '2028-02-28T00:00:00', 'Fernanda', 'Semestral', 'Mensal', 'Trimestral', 'Financiamento Construção', 'Ba6', 'Ba4', 'Verde', 0.7, 1.6, true, true, 'Ativa', 'Galpões BTS BTL em SC.', NULL, FALSE, NULL, NULL, NULL, NULL, TRUE, NULL, NULL, '2024-01-01T00:00:00'),
(60, 'Debênture Tech Infra (Legado)', 4, NULL, 'Capital Solutions', 'Debênture', '2024-01-30T00:00:00', 'João', 'Anual', 'Anual', 'Anual', 'Infraestrutura', 'A1', 'A1', 'Verde', 0.3, 3.5, false, false, 'Legada', 'Operação já liquidada.', '2024-02-05T00:00:00', FALSE, NULL, NULL, NULL, NULL, FALSE, NULL, NULL, '2024-01-01T00:00:00'),

-- ORIGINAÇÃO / ESTRUTURAÇÃO (is_structuring = TRUE)
(101, 'CRI Faria Lima Fase 2', 1, 1, 'CRI', NULL, NULL, 'Fernanda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, NULL, NULL, NULL, TRUE, 'Em Estruturação', 'High Grade', 'Morno', '2024-12-15T00:00:00', TRUE, 'Orig Faria', 'Projeto', '2024-10-01T00:00:00'),
(102, 'CRA Agro Forte Expansão', 2, 3, 'CRA', NULL, NULL, 'Ricardo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, NULL, NULL, NULL, TRUE, 'Mandato Assinado', 'High Yield', 'Quente', '2024-11-30T00:00:00', TRUE, 'Orig Agro', 'Corporativo', '2024-10-05T00:00:00'),
(103, 'Debênture Logística Sul', 3, 4, 'Capital Solutions', NULL, NULL, 'João', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, NULL, NULL, NULL, TRUE, 'Conversa Inicial', 'High Yield', 'Frio', '2025-03-01T00:00:00', TRUE, 'Orig Sul', 'Aquisição', '2024-10-10T00:00:00'),
(104, 'CRI Faria Lima Refin', 1, 1, 'CRI', NULL, NULL, 'Fernanda', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, NULL, NULL, NULL, TRUE, 'Comitê Aprovado', 'High Grade', 'Quente', '2024-10-15T00:00:00', TRUE, 'Orig Faria', 'Refin', '2024-09-01T00:00:00'),
(105, 'Debênture Tech Infra Nova', 4, NULL, 'Capital Solutions', NULL, NULL, 'João', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, false, false, NULL, NULL, NULL, TRUE, 'Liquidação', 'High Grade', 'Morno', '2024-10-30T00:00:00', FALSE, 'Orig Tech', 'Corporativo', '2024-08-01T00:00:00');
