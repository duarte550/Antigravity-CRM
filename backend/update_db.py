...
SCHEMA = {
    ...
    "cri_cra_dev.crm.task_checklist_items": [
        "id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY",
        "task_rule_id BIGINT NOT NULL",
        "title STRING NOT NULL",
        "is_completed BOOLEAN",
        "completed_by STRING",
    ...
    "cri_cra_dev.crm.task_assignees": [
        "id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY",
        "task_rule_id BIGINT NOT NULL",
...
COMITE_SCHEMA = {
    ...
    "cri_cra_dev.comite.comite_voto_historico": [
        "id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY",
        "voto_id BIGINT NOT NULL",
        "user_id BIGINT NOT NULL",
        "tipo_voto_anterior STRING",       # aprovado | reprovado | discussao (null on first vote)
        "tipo_voto_novo STRING NOT NULL",  # aprovado | reprovado | discussao
