# Walkthrough: Integração Microsoft Entra ID

## Resumo

Implementada a integração completa com Microsoft Entra ID usando `@azure/msal-react`, substituindo o `MockAuthContext` por um `AuthContext` dual-mode que suporta:
- **Modo Entra ID:** Autenticação real via token Microsoft com mapeamento de App Roles
- **Modo Mock:** Mantido para desenvolvimento, com toggle controlado pelo administrador

## Arquivos Criados

### [authConfig.ts](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/authConfig.ts)
Configuração centralizada do MSAL (clientId, tenantId, scopes) via variáveis de ambiente Vite.

### [.env.example](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/.env.example)
Template com `VITE_ENTRA_CLIENT_ID` e `VITE_ENTRA_TENANT_ID`.

### [AuthContext.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/contexts/AuthContext.tsx)
Novo contexto de autenticação dual-mode. Interface `useAuth()` **idêntica** ao anterior, garantindo zero breaking changes nos componentes consumidores.

### [LoginPage.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/components/LoginPage.tsx)
Tela de login premium com glassmorphism e botão "Entrar com Microsoft".

### [AdminPanel.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/components/AdminPanel.tsx)
Modal acessível pelo ícone ⚙️ no header (visível apenas para admins). Permite:
- Toggle Entra ID ↔ Mock
- Visualizar dados do usuário atual (nome, email, roles, modo)
- Controlar perfis e roles mock (quando no modo Mock)
- Logout da conta Microsoft

## Arquivos Modificados

### [index.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/index.tsx)
```diff:index.tsx
...
### [App.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/App.tsx)
```diff:App.tsx
...
### [Sidebar.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/components/Sidebar.tsx)
Import path atualizado: `MockAuthContext` → `AuthContext`

### [ComiteDetailPage.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/components/ComiteDetailPage.tsx)
Import path atualizado: `MockAuthContext` → `AuthContext`

### [ComiteVideoPage.tsx](file:///c:/Users/duart/OneDrive/Desktop/CRM%20Antigravity%20controle/CRM%20Antigravity/Antigravity-CRM/frontend/components/ComiteVideoPage.tsx)
Import path atualizado: `MockAuthContext` → `AuthContext`
...
| Lint errors corrigidos | ✅ Removidas props inválidas da MSAL v4 |
| Interface `useAuth()` mantida | ✅ Drop-in replacement, nenhum componente quebrou |

## Próximos Passos (para o usuário)

1. **Criar `.env`** na pasta `frontend/` com os IDs do Entra:
   ```
   VITE_ENTRA_CLIENT_ID=<seu-client-id>
   VITE_ENTRA_TENANT_ID=<seu-tenant-id>
   ```

2. **Testar modo Mock** — Com `.env` sem Client ID, o app inicia em modo Mock automaticamente

3. **Testar modo Entra ID** — Com `.env` preenchido, o app exigirá login Microsoft

4. O arquivo `MockAuthContext.tsx` antigo e `DevToggleBar.tsx` podem ser removidos quando confirmado que tudo funciona
